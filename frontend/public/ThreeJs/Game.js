class Game {
    ...
    init() {
        ...
        this.player = new PlayerLocal(this, null, this.character);
        ...
        document.addEventListener('keydown', (event) => {
            switch (event.key) {
                case "j":
                    // 发送广播事件
                    this.chessBoard.socket.emit('game-interact', {
...
class Player {
    constructor(game, options, character = "Random") {
        this.local = true;
        let model, colour;
...
class PlayerLocal extends Player {
    constructor(game, model, character = "Random") {
